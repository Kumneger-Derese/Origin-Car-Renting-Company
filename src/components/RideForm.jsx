  ...
  return (
    ...
    >
        ...
        <section className='flex flex-col sm:flex-row gap-2 items-center'>
          <div className='flex p-2 relative'>
            <input
              ...
              className='pl-10 py-2 rounded-xl bg-light'
            />
            <GoLocation size={18} className='absolute  inset-x-6 top-5' />
          </div>

          <div className='bg-light rounded-xl flex  gap-x-2 p-2 items-center'>
      ...
      <div className='flex flex-col flex-1/2'>
        ...
        <section className='flex flex-col sm:flex-row gap-2 items-center mb-2'>
          <div className='flex p-2 relative'>
            <input
              type='text'
              placeholder='Choose Location'

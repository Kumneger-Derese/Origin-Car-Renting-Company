...
const Fleets = () => {
    ...
    return (
        <div ref={containerRef} id={'fleets'} className={'flex flex-col gap-y-12 px-16'}>
            ...
            <div className={'flex flex-col gap-y-8'}>
                ...
                <div className={'grid grid-cols-3 sm:grid-cols-6 gap-4 mx-auto'}>
                    {
                        carCategory.map((item, index) => (
                            <button key={index}
                                    ...
                                    className={`cat-card px-4 py-1.5 rounded-xl bg-gray-300 capitalize
                ...
                <div className={'grid grid-cols-1 lg:mx-20 gap-y-4 sm:grid-cols-2 lg:grid-cols-3 place-items-center' +
                    'mx-auto'}>
                    {
                        categories.map((fleet) => (
                            <div key={fleet.id} className={'car-card overflow-hidden rounded-xl relative max-sm:size-64  sm:w-80 sm:h-64 lg:size-64 bg-light'}>
